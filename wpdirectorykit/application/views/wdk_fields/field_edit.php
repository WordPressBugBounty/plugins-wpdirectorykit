...
<div class="wrap wdk-wrap">
    <h1 class="wp-heading-inline"><?php echo esc_html__('Fields Management', 'wpdirectorykit'); ?></h1>
    <br />
    <div class="wdk-body">
        <div class="postbox" style="display: block;">
            <div class="postbox-header">
                <h3><?php echo esc_html__('Add/Edit Field', 'wpdirectorykit'); ?></h3>
            </div>
            <div class="inside">
                ...
                <form method="post" class="form_listing_ai" action="<?php echo esc_url(wmvc_current_edit_url()); ?>" novalidate="novalidate">
                    ...
                    $form->messages(
                        ...
                        wp_kses(
                            sprintf(
                                /* translators: 1: URL. */
                                __('Successfully saved, <a href="%1$s">Back to Fields Management </a>', 'wpdirectorykit'),
                                esc_url(admin_url('admin.php?page=wdk_fields'))
                            ),
                            array(
                                'a' => array(
                                    'href' => true,
                    ...
                    <table class="form-table" role="presentation">
                        <tbody>
                            <?php if (wmvc_show_data('field_type', $db_data) != "SECTION"): ?>
                                <tr>
                                    <th scope="row">
                                        <label for="field_type"><?php echo esc_html__('Section', 'wpdirectorykit'); ?></label>
                                    </th>
                                    <td>
                                        <?php
                                            echo wp_kses(
                                                wmvc_select_option('section', $section_list, $selected_section),
                                                array(
                                                    'select' => array(
                                                        'id' => true,
                                                        'name' => true,
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="field_type"><?php echo esc_html__('Field Type', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    <?php
                                    echo wp_kses(
                                        wmvc_select_option('field_type', $field_types, wmvc_show_data('field_type', $db_data, '')),
                                        array(
                                            'select' => array(
                                                'id' => true,
                                                'name' => true,
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="date_format"><?php echo esc_html__('Date format', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description" id="hint-description">
                                        <?php echo esc_html__('Date Format for Front - End View', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="field_label"><?php echo esc_html__('Field Label', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><label for="hint"><?php echo esc_html__('Hint', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    <input name="hint" type="text" id="hint"
                                        ...
                                        class="regular-text">
                                    <p class="description" id="hint-description">
                                        <?php echo esc_html__('Hint is showing below fields like this one', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="placeholder"><?php echo esc_html__('Placeholder', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description" id="placeholder-description">
                                        <?php echo esc_html__('Placeholder is showing on placeholder of fields or first value on dropdown', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label
                                        for="columns_number"><?php echo esc_html__('Columns number/Width', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description" id="columns_number-description">
                                        <?php echo esc_html__('Full width is 12 columns, so define wanted columns allocation number for this field', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php echo esc_html__('Field is required', 'wpdirectorykit'); ?></th>
                                <td>
                                    <fieldset>
                                        <legend class="screen-reader-text">
                                            <span><?php echo esc_html__('Field is required', 'wpdirectorykit'); ?></span>
                                        </legend>
                                        <label for="is_required">
                                            <input name="is_required" type="checkbox" id="is_required"
                                                value="1"
                                                <?php echo !empty(wmvc_show_data('is_required', $db_data, '')) ? 'checked' : ''; ?>>
                                            <?php echo esc_html__('Required', 'wpdirectorykit'); ?>
                                            <?php echo esc_html__('( Not for section type)', 'wpdirectorykit'); ?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php echo esc_html__('Field is visible on Listing Preview', 'wpdirectorykit'); ?></th>
                                <td>
                                    <fieldset>
                                        <legend class="screen-reader-text">
                                            <span><?php echo esc_html__('Field is visible on Listing Preview', 'wpdirectorykit'); ?></span>
                                        </legend>
                            ...
                            <tr>
                                <th scope="row"><?php echo esc_html__('Field is visible on frontend submission', 'wpdirectorykit'); ?></th>
                                <td>
                                    <fieldset>
                                        <legend class="screen-reader-text">
                                            <span><?php echo esc_html__('Field is visible on frontend submission', 'wpdirectorykit'); ?></span>
                                        </legend>
                            ...
                            <tr>
                                <th scope="row"><?php echo esc_html__('Price format', 'wpdirectorykit'); ?></th>
                                <td>
                                    <fieldset>
                                        <legend class="screen-reader-text">
                                            <span><?php echo esc_html__('Price format', 'wpdirectorykit'); ?></span>
                                        </legend>
                                        <label for="is_price_format">
                                            ...
                                            <?php echo esc_html__('Use wp price format based on language ( Only for number field type)', 'wpdirectorykit'); ?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="validation"><?php echo esc_html__('Validation', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    <?php
                                    echo wp_kses(
                                        wmvc_select_option(
                                            'validation',
                                            array_merge(array('' => __('Not Selected', 'wpdirectorykit')), $this->field_m->fields_validations),
                                            wmvc_show_data('validation', $db_data, ''),
                                            'id="validation"'
                                        ),
                                        array(
                                            'select' => array(
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="autosuggestion"><?php echo esc_html__('Autosuggestion', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    <select name="autosuggestion" id="autosuggestion"
                                        ...
                                        <?php endif; ?>>
                                        <option value=""><?php echo esc_html__('Not Selected', 'wpdirectorykit'); ?></option>
                            ...
                            <tr>
                                <th scope="row"><label
                                        for="min_length"><?php echo esc_html__('Min Length', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    <input name="min_length" type="number" id="min_length"
                                        ...
                                        class="regular-text">
                                    <p class="description" id="columns_number-description">
                                        <?php echo esc_html__('Min Characters or min number (if number field type)', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label
                                        for="max_length"><?php echo esc_html__('Max Length', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    <input name="max_length" type="number" id="max_length"
                                        ...
                                        class="regular-text">
                                    <p class="description" id="columns_number-description">
                                        <?php echo esc_html__('Max Characters or max number (if number field type)', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <?php if (false): ?>
                                <tr>
                                    <th scope="row"><?php echo esc_html__('Visible on', 'wpdirectorykit'); ?></th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php echo esc_html__('Visible on', 'wpdirectorykit'); ?></span>
                                            </legend>
                                            <label for="is_visible_frontend">
                                                <input name="is_visible_frontend" type="checkbox" id="is_visible_frontend"
                                                    value="1"
                                                    <?php echo !empty(wmvc_show_data('is_visible_frontend', $db_data, '')) ? 'checked' : ''; ?>>
                                                <?php echo esc_html__('Frontend', 'wpdirectorykit'); ?>
                                            </label>
                                            <label for="is_visible_dashboard">
                                                <input name="is_visible_dashboard" type="checkbox" id="is_visible_dashboard"
                                                    value="1"
                                                    <?php echo !empty(wmvc_show_data('is_visible_dashboard', $db_data, '')) ? 'checked' : ''; ?>>
                                                <?php echo esc_html__('Dashboard', 'wpdirectorykit'); ?>
                                            </label>
                                        </fieldset>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            <tr>
                                <th scope="row"><label for="icon_id"><?php echo esc_html__('Icon', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    <?php
                                    ...
                                    <p class="description" id="icon_id-description">
                                        <?php echo esc_html__('Icon used for amenities or special places on website', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="prefix"><?php echo esc_html__('Prefix', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description" id="prefix-description">
                                        <?php echo esc_html__('Visible before field value usable in currency like $999', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="suffix"><?php echo esc_html__('Suffix', 'wpdirectorykit'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description" id="suffix-description">
                                        <?php echo esc_html__('Visible after field value usable in metrics like 200ft', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label
                                        for="values_list"><?php echo esc_html__('Values', 'wpdirectorykit'); ?></label></th>
                                <td>
                                    ...
                                    <p class="description" id="values_list-description">
                                        <?php echo esc_html__('Values selectable in dropdown, separate with, like value1,value2,value3', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label
                                        for="empty_value"><?php echo esc_html__('Value when empty', 'wpdirectorykit'); ?></label></th>
                                <td>
                                    ...
                                    <p class="description" id="empty_value-description">
                                        <?php echo esc_html__('This value will be visible if this field is not populated', 'wpdirectorykit'); ?>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
