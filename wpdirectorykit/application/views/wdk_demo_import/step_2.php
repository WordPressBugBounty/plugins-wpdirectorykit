    ...
    <div class="wdk-body">
        <div class="postbox" style="display: block;">
            <div class="postbox-header">
                <h3><?php echo esc_html__('Step 2 Import for theme:', 'wpdirectorykit'); ?> <?php echo esc_html($current_theme->get( 'Name' )); ?></h3>
            </div>
            <div class="inside">
                <div class="wdk-install-plugins-content-header">
                    <h2><?php echo esc_html__('Importing Demo Content', 'wpdirectorykit'); ?></h2>
                    <p><?php echo esc_html__('Now we importing demo content like Pages/Posts/Menus and Listings', 'wpdirectorykit'); ?></p>
                </div>
                    <label slug="" source="" class="plugin-item install_content">
                        <div class="plugin-item-content">
                            <div class="plugin-item-content-title">
                                <h3><img src="<?php echo esc_url(WPDIRECTORYKIT_URL); ?>admin/img/loader.svg" class="wdk-loading wdk-loading-md hidden" alt="Loading..."><?php echo esc_html__('Importing Pages/Posts/Menus','wpdirectorykit'); ?></h3>
                            </div>
                    ...
                    <label slug="" source="" class="plugin-item install_listings">
                        <div class="plugin-item-content">
                            <div class="plugin-item-content-title">
                                <h3><img src="<?php echo esc_url(WPDIRECTORYKIT_URL); ?>admin/img/loader.svg" class="wdk-loading wdk-loading-md hidden" alt="Loading..."><?php echo esc_html__('Importing Listings and Configurations','wpdirectorykit'); ?></h3>
                            </div>
                            <div class="plugin-item-error js-wdk-plugin-item-error"></div>
                            <div class="plugin-item-info js-wdk-plugin-item-info"></div>
                        </div>
        ...
        <p class="wdk_button-container">
            <a href="<?php echo esc_url(get_home_url());?>" class="install_button wdk_button button button-hero button-primary" disabled="disabled"><?php echo esc_html__('Visit Website', 'wpdirectorykit'); ?></a>
        </p>
    </div>
    <br/>
    ...
    function install_content(){
        ...
        var jqxhr = $.post( "<?php echo esc_url(admin_url('admin-ajax.php')); ?>", ajax_param, function(data)
        {
            if(data.success == true)
            {
                ...
                that.after("<div class=\"alert alert-danger\" role=\"alert\"><?php echo esc_html__('Error:', 'wpdirectorykit'); ?>  <b style=\"color:red;\">"+data.message+"</b></div>");
            }
            else
            {
