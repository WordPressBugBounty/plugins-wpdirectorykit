...
class WdkCoolListingCarousel extends WdkElementorBase {
    ...
    public function get_title() {
        return esc_html__('Wdk Listing Carousel', 'wpdirectorykit');
    }
    ...
    private function generate_controls_styles() {
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        ''  => __( 'Default', 'wpdirectorykit' ),
                        'wdk-listing-carousel_arrows_bottom'  => __( 'Bottom', 'wpdirectorykit' ),
                        'wdk-listing-carousel_arrows_middle' => __( 'Center', 'wpdirectorykit' ),
                        'wdk-listing-carousel_arrows_top' => __( 'Top', 'wpdirectorykit' ),
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        '' => __( 'Default', 'wpdirectorykit' ),
                        'wdk-listing-carousel_dots_out' => __( 'Out', 'wpdirectorykit' ),
                        'wdk-listing-carousel_dots_in' => __( 'In', 'wpdirectorykit' ),
                    ],
                ]
            );
