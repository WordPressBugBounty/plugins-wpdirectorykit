 ...
 * @since 1.1.0
 */
class WdkButtonShare extends WdkElementorBase {
    ...
    public function get_title() {
        return esc_html__('Wdk Button Share', 'wpdirectorykit');
    }
    ...
    protected function render() {
        ...
        $this->data['link_url'] = wdk_current_url();

        if(!empty($this->data['settings']['link_url']))
            $this->data['link_url'] = $this->data['settings']['link_url'];
    ...
    private function generate_controls_conf() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Share', 'wpdirectorykit'),
                'separator' => 'before',
            ]
        );
