...
class WdkListingSlidersGridMoreImages extends WdkElementorBase {
    ...
    public function get_title() {
        return esc_html__('Wdk Listing Slider More Grid', 'wpdirectorykit');
    }
    ...
    private function generate_controls_conf() {
        ...
        $this->add_control(
            'gallery_enable',
            [
                'label' => __( 'Gallery Enable (instead slider)', 'wpdirectorykit' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __( 'On', 'wpdirectorykit' ),
                'label_off' => __( 'Off', 'wpdirectorykit' ),
                'return_value' => 'yes',
    ...
    private function generate_controls_styles() {
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__('Container', 'wpdirectorykit'),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        ''  => __( 'Default', 'wpdirectorykit' ),
                        'wdk-listing-sliders-more-grid-images_arrows_bottom'  => __( 'Bottom', 'wpdirectorykit' ),
                        'wdk-listing-sliders-more-grid-images_arrows_middle' => __( 'Center', 'wpdirectorykit' ),
                        'wdk-listing-sliders-more-grid-images_arrows_top' => __( 'Top', 'wpdirectorykit' ),
                    ],
                ]
            );
