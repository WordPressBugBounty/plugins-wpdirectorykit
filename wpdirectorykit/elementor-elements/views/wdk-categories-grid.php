...
<script>
 jQuery(document).ready(function($){
            $('#wdk_el_<?php echo esc_html($id_element);?> .wdk-carousel_ini').slick({
                ...
                slidesToShow: <?php echo esc_html(wmvc_show_data('layout_carousel_columns', $settings, 1));?>,
                slidesToScroll: <?php echo esc_html(wmvc_show_data('layout_carousel_columns', $settings,1));?>,
                <?php if(!empty(wmvc_show_data('layout_carousel_is_infinite', $settings))):?>
                infinite: <?php echo esc_html(wmvc_show_data('layout_carousel_is_infinite', $settings, 'true'));?>,
                <?php endif;?>
                ...
                autoplaySpeed: <?php echo esc_html(wmvc_show_data('layout_carousel_autoplaySpeed', $settings, '1500'));?>,
                <?php endif;?>
