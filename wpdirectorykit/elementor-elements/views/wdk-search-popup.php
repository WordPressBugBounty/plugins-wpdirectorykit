                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        switch (wmvc_show_data('action_list_field_id', $custom_button)):
                            case 'button_reset':
                                echo '<button type="button" class="wdk-btn wdk-button-search-reset wdk-search-reset">'.(!empty(wmvc_show_data('placeholder', $custom_button)) ? esc_html(wmvc_show_data('placeholder', $custom_button)) : esc_html__('Reset', 'wpdirectorykit')).'</button>';
                                break;
                                case 'button_search':
                                    echo '<button type="submit" class="wdk-btn wdk-button-search-start wdk-click-load-animation">'.(!empty(wmvc_show_data('placeholder', $custom_button)) ? esc_html(wmvc_show_data('placeholder', $custom_button)) : esc_html__('Search', 'wpdirectorykit')).'</button>';
                                    break;
                                    case 'button_close':
                                        echo '<button type="button" class="wdk-btn wdk-button-close" data-wdk-dismiss="modal">'.(!empty(wmvc_show_data('placeholder', $custom_button)) ? esc_html(wmvc_show_data('placeholder', $custom_button)) : esc_html__('Close', 'wpdirectorykit')).'</button>';
                                        break;
