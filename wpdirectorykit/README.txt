...
= 1.5.5 =
* Improve find gps by Google API
* Quick navigation added to the Listing Edit page for easier switching between listings
* Fixed security 

= 1.5.4 =
* Fixed security 
* Fixed conflict with WC REST API
* Support Wp version 7
