...
class Wpdirectorykit_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_register_style('select2-select2', WPDIRECTORYKIT_URL . 'public/js/select2/css/select2.min.css', array(), '4.0.13', 'all');
    ...
    public function enqueue_scripts()
    {
        ...
        wp_register_script('select2-select2', WPDIRECTORYKIT_URL . 'public/js/select2/js/select2.min.js', array('jquery'), '4.0.13', false);
    ...
    public function plugin_menu()
    {
        ...
        add_menu_page(
            __('Directory Kit', 'wpdirectorykit'),
            __('Directory Kit', 'wpdirectorykit'),
            'wdk_listings_manage',
            'wdk',
        ...
        add_submenu_page(
            ...
            __('Documentation', 'wpdirectorykit'),
            'wdk_listings_manage',
            'https://wpdirectorykit.com/documentation'
        );
        ...
        add_submenu_page(
            ...
            __('Support Forum', 'wpdirectorykit'),
            'wdk_listings_manage',
            'https://wordpress.org/support/plugin/wpdirectorykit/'
        );
        ...
        add_submenu_page(
            ...
            __('Contact', 'wpdirectorykit'),
            'wdk_listings_manage',
            'https://wpdirectorykit.com/contact.html'
        );
        //}
        ...
        if (defined('WP_DEBUG') && WP_DEBUG && $current_theme->get('AuthorURI') == 'https://wpdirectorykit.com')
            add_submenu_page(
                'tools.php',
                esc_html__('WDK Demo Import', 'wpdirectorykit'),
                esc_html__('WDK Demo Import', 'wpdirectorykit'),
                'wdk_listings_manage',
                'wdk_demo_import',
                array($this, 'admin_page_display')
