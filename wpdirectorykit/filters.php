        ...
        if ($wp_query->post->post_type == 'wdk-listing') {
            ...
            if (!empty($wdk_listing_page_id) && get_post_status($wdk_listing_page_id) == 'publish') {
                ...
                if (
                    ...
                    /* if login required */ elseif (get_option('wdk_membership_login_required_listing_preview') && !is_user_logged_in()) {
...
add_action('wdk/listing/edit/aboveform', function () {

    if (function_exists('fpai_register_settings')) return false;
    ...
    $popup_css = '
        ...
        .fpai-ai-button .fpai-button-text {
            color: #fff;
        }
...
?>
    <a class="fpai-ai-button fpai-pro" 
        <?php if (!file_exists(ABSPATH . 'wp-content/plugins/form-populate-with-ai/form-populate-with-ai.php')): ?>
        data-button-succuss="<?php echo esc_attr__('Install', 'wpdirectorykit'); ?>"
        data-title="<?php echo esc_attr__('Form Populate with AI', 'wpdirectorykit'); ?>"
        data-content="<?php echo esc_attr__('Please install our free plugin AI Form Populate to use this feature and button should open our website with plugin details', 'wpdirectorykit'); ?>"
        data-action="<?php echo esc_url(admin_url('plugin-install.php?tab=plugin-information&plugin=form-populate-with-ai&TB_iframe=true&width=600&height=550' )); ?>"
        <?php elseif (file_exists(ABSPATH . 'wp-content/plugins/form-populate-with-ai/form-populate-with-ai.php') && !function_exists('fpai_register_settings')): ?>
        data-button-succuss="<?php echo esc_attr__('Activate', 'wpdirectorykit'); ?>"
        data-title="<?php echo esc_attr__('Form Populate with AI', 'wpdirectorykit'); ?>"
        data-content="<?php echo esc_attr__('Please install our free plugin AI Form Populate to use this feature and button should open our website with plugin details', 'wpdirectorykit'); ?>"
        ...
        <?php endif; ?>
    >
        <span class="fpai-stars-container">
            <span class="fpai-star">⭐</span>
            <span class="fpai-star">✨</span>
            <span class="fpai-star">🌟</span>
        </span>
        <span class="fpai-button-text"><?php echo esc_html__('Populate with AI', 'wpdirectorykit'); ?></span>
    </a> 

    <script>
jQuery(document).ready(function ($) {
    if (typeof jQuery.fn.confirm == 'function') {
        jQuery('.fpai-pro').off().on('click', function (e) {
				e.preventDefault();
